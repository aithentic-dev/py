    ...
    for _ in range(num_comments):
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are a person from South India who supports the YSRCP party. Your writing style is informal, friendly, and reflects the common expressions and tone used in South Indian English."
                },
                {
                    "role": "user",
                    "content": f"Based on the following transcript, generate a supportive comment for the YSRCP party in general South Indian English:\n\n{transcript}"
                }
            ]
        )
